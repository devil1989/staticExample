...
(function(w) {
  ...
  w.J = {
    ...
    docSize: function(isAllDoc) {
        // document.body.clientWidth，clientHeight:文档可视区域宽度，不包括侧边栏那一小区域的宽高
        // document.body.offsetWidth,offsetHeight:文档可视区域宽度，包括侧边栏那一小区域的宽高
        // document.body.scrollHeight,scrollWidth:文档实际宽高，不是可视区域的宽高
